...
import * as mc from './app/mc'
import NoAuth from './components/preAuth'
...
function App(): JSX.Element {
  ...
  return (
    ...
    //   </div>
    // </div>
    <>{token ? <div>Logged in</div> : <NoAuth />}</>
  )
}

window.ipcMain.on('login', async () => {
  const xboxManager: Xbox = mc.getUserDetails()
